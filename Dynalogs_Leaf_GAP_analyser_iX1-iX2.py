...
### To upload dynalogs from RapidArc_iX1 ###
fileListR1 = []
for f in Path('Z:/Aurelien_Dynalogs/0000_Fichiers_Dynalogs_A_Analyser/temp_export/RapidArc_iX1').walkfiles(): 
    fileListR1.append(f)

PFRot_File_List = []
Patient_File_List = []
for elm in fileListR1:
    if elm[107:] == "PF ROTAT.dlg":
...
for file in TruePatient_File_List:
    shutil.move(file, 'Z:/Aurelien_Dynalogs/0000_Fichiers_Dynalogs_A_Analyser/Patients_traites/RapidArc_iX1')

for elm in Bin_File_List:
    os.remove(elm)


### To upload dynalogs from RapidArc_iX2 ###
fileListR2 = []
for f in Path('Z:/Aurelien_Dynalogs/0000_Fichiers_Dynalogs_A_Analyser/temp_export/RapidArc_iX2').walkfiles(): 
    fileListR2.append(f)

PFRot_File_List = []
Patient_File_List = []
for elm in fileListR2:
    if elm[107:] == "PF ROTAT.dlg":
        PFRot_File_List.append(elm)
    else:
        Patient_File_List.append(elm)
...
for file in TruePatient_File_List:
    shutil.move(file, 'Z:/Aurelien_Dynalogs/0000_Fichiers_Dynalogs_A_Analyser/Patients_traites/RapidArc_iX2')
